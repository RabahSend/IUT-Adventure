...
prog.exe : src/main.o includes/ASCII.o includes/dialogues.o includes/terminal.o includes/TextGame.o Mobs_and_Persos/Entity.o
	$(CXX) -o prog.exe src/main.o includes/ASCII.o includes/dialogues.o includes/terminal.o includes/TextGame.o Mobs_and_Persos/Entity.o
